...
static const struct SmogonMoves sMienfooMoves_gen8lc[] =
{
	...
	{MOVE_POISON_JAB, 351},
	// {MOVE_TAUNT, 245}, // commented out because AI handles the move badly
	{MOVE_ACROBATICS, 200},
	{MOVE_SWORDS_DANCE, 166},
	// {MOVE_PROTECT, 114}, // commented out because AI handles the move badly
	{MOVE_ROCK_SLIDE, 88},
	// {MOVE_SUBSTITUTE, 58}, // commented out because AI handles the move badly
};
...
static const struct SmogonMoves sGrookeyMoves_gen8lc[] =
{
	...
	{MOVE_U_TURN, 3449},
	// {MOVE_PROTECT, 1312}, // commented out because AI handles the move badly
...
static const struct SmogonTeammates sGrookeyTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 289},
	{SPECIES_LILEEP, 285},
...
static const struct SmogonMoves sDiglettMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 3488}, // commented out because AI handles the move badly
	{MOVE_BEAT_UP, 3330},
	{MOVE_SUCKER_PUNCH, 2940},
	// {MOVE_SUBSTITUTE, 1968}, // commented out because AI handles the move badly
	{MOVE_MEMENTO, 1899},
...
static const struct SmogonTeammates sDiglettTeammates_gen8lc[] =
{
	...
	{SPECIES_MAGBY, 1388},
	{SPECIES_TYRUNT, 1356},
	{SPECIES_FARFETCHD_GALARIAN, 1094},
...
static const struct SmogonTeammates sTimburrTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 994},
	{SPECIES_FOONGUS, 890},
...
static const struct SmogonMoves sPawniardMoves_gen8lc[] =
{
	...
	// {MOVE_TAUNT, 680}, // commented out because AI handles the move badly
	{MOVE_BEAT_UP, 575},
	{MOVE_X_SCISSOR, 378},
	{MOVE_PSYCHO_CUT, 345},
	{MOVE_LOW_SWEEP, 209},
...
static const struct SmogonMoves sAbraMoves_gen8lc[] =
{
	...
	// {MOVE_SUBSTITUTE, 3981}, // commented out because AI handles the move badly
	{MOVE_DRAIN_PUNCH, 3616},
	{MOVE_FIRE_PUNCH, 2717},
	// {MOVE_PROTECT, 2418}, // commented out because AI handles the move badly
	{MOVE_COUNTER, 1881},
...
static const struct SmogonTeammates sAbraTeammates_gen8lc[] =
{
	...
	{SPECIES_SANDSHREW_ALOLAN, 367},
	{SPECIES_FARFETCHD_GALARIAN, 349},
...
static const struct SmogonMoves sNatuMoves_gen8lc[] =
{
	...
	{MOVE_GIGA_DRAIN, 246},
	// {MOVE_SUBSTITUTE, 167}, // commented out because AI handles the move badly
	{MOVE_AIR_SLASH, 98},
};
...
static const struct SmogonTeammates sPonytaTeammates_gen8lc[] =
{
	...
	{SPECIES_MUDBRAY, 490},
	{SPECIES_FARFETCHD_GALARIAN, 361},
...
static const struct SmogonTeammates sPorygonTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 1643},
...
static const struct SmogonTeammates sLarvestaTeammates_gen8lc[] =
{
	...
	{SPECIES_NATU, 2386},
	{SPECIES_ABRA, 1866},
	{SPECIES_FARFETCHD_GALARIAN, 1704},
...
static const struct SmogonMoves sMagnemiteMoves_gen8lc[] =
{
	...
	{MOVE_REST, 152},
	// {MOVE_SUBSTITUTE, 152}, // commented out because AI handles the move badly
	{MOVE_THUNDER, 87},
};
...
static const struct SmogonTeammates sMagnemiteTeammates_gen8lc[] =
{
	...
	{SPECIES_PONYTA, 2482},
	{SPECIES_FARFETCHD_GALARIAN, 2259},
...
static const struct SmogonMoves sFrillishMoves_gen8lc[] =
{
	...
	// {MOVE_TAUNT, 705}, // commented out because AI handles the move badly
	{MOVE_PSYCHIC, 513},
	{MOVE_SURF, 277},
	// {MOVE_PROTECT, 150}, // commented out because AI handles the move badly
...
static const struct SmogonTeammates sFrillishTeammates_gen8lc[] =
{
	...
	{SPECIES_DRILBUR, 985},
	{SPECIES_ARCHEN, 830},
	{SPECIES_FARFETCHD_GALARIAN, 682},
	{SPECIES_ANORITH, 544},
...
static const struct SmogonMoves sDwebbleMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 824}, // commented out because AI handles the move badly
	{MOVE_COUNTER, 529},
	{MOVE_X_SCISSOR, 360},
	{MOVE_ROCK_TOMB, 216},
	{MOVE_ROCK_SLIDE, 195},
...
static const struct SmogonTeammates sDwebbleTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 216},
...
static const struct SmogonMoves sOnixMoves_gen8lc[] =
{
	...
	// {MOVE_TAUNT, 735}, // commented out because AI handles the move badly
	{MOVE_TOXIC, 492},
	{MOVE_BODY_PRESS, 221},
	// {MOVE_PROTECT, 214}, // commented out because AI handles the move badly
	// {MOVE_SUBSTITUTE, 193}, // commented out because AI handles the move badly
	{MOVE_ENDURE, 77},
};
...
{
	{MOVE_CRUNCH, 9889},
	// {MOVE_PROTECT, 9832}, // commented out because AI handles the move badly
...
static const struct SmogonTeammates sCarvanhaTeammates_gen8lc[] =
{
	...
	{SPECIES_ARCHEN, 387},
	{SPECIES_FARFETCHD_GALARIAN, 385},
...
static const struct SmogonMoves sMagbyMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 1496}, // commented out because AI handles the move badly
	// {MOVE_SUBSTITUTE, 498}, // commented out because AI handles the move badly
...
static const struct SmogonTeammates sMagbyTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 232},
...
static const struct SmogonMoves sSpritzeeMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 772}, // commented out because AI handles the move badly
	{MOVE_COVET, 755},
...
static const struct SmogonTeammates sSpritzeeTeammates_gen8lc[] =
{
	...
	{SPECIES_VULPIX, 806},
	{SPECIES_FARFETCHD_GALARIAN, 778},
	{SPECIES_MUDBRAY, 640},
...
static const struct SmogonTeammates sMareanieTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 1549},
	{SPECIES_TIMBURR, 842},
	{SPECIES_VULPIX, 699},
...
static const struct SmogonTeammates sFarfetchd_GalarTeammates_gen8lc[] =
{
	...
	{SPECIES_SANDSHREW_ALOLAN, 562},
	{SPECIES_PONYTA_GALARIAN, 560},
	{SPECIES_BONSLY, 512},
	{SPECIES_DWEBBLE, 456},
...
static const struct SmogonMoves sArchenMoves_gen8lc[] =
{
	...
	// {MOVE_SUBSTITUTE, 1354}, // commented out because AI handles the move badly
...
static const struct SmogonMoves sCroagunkMoves_gen8lc[] =
{
	...
	{MOVE_GUNK_SHOT, 91},
	// {MOVE_TAUNT, 64}, // commented out because AI handles the move badly
};
...
static const struct SmogonMoves sMunchlaxMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 1901}, // commented out because AI handles the move badly
	{MOVE_COUNTER, 922},
	{MOVE_REST, 785},
	{MOVE_FACADE, 769},
	{MOVE_TOXIC, 590},
...
static const struct SmogonMoves sPonyta_GalarMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 536}, // commented out because AI handles the move badly
...
static const struct SmogonTeammates sPonyta_GalarTeammates_gen8lc[] =
{
	...
	{SPECIES_ABRA, 1725},
	{SPECIES_AMAURA, 1725},
	{SPECIES_FARFETCHD_GALARIAN, 1725},
	{SPECIES_SANDSHREW_ALOLAN, 1725},
...
static const struct SmogonTeammates sElekidTeammates_gen8lc[] =
{
	...
	{SPECIES_ZORUA, 127},
	{SPECIES_DWEBBLE, 106},
	{SPECIES_FARFETCHD_GALARIAN, 106},
	{SPECIES_MANTYKE, 67},
	{SPECIES_CARVANHA, 64},
...
static const struct SmogonTeammates sSandshrew_AlolaTeammates_gen8lc[] =
{
	...
	{SPECIES_SNOVER, 3086},
	{SPECIES_AMAURA, 2514},
	{SPECIES_FARFETCHD_GALARIAN, 1935},
	{SPECIES_PONYTA_GALARIAN, 1930},
	{SPECIES_BONSLY, 1764},
...
static const struct SmogonTeammates sZoruaTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 120},
	{SPECIES_ARCHEN, 81},
	{SPECIES_TRAPINCH, 78},
	{SPECIES_GROOKEY, 69},
	{SPECIES_PONYTA_GALARIAN, 69},
	{SPECIES_SOBBLE, 69},
};
...
static const struct SmogonMoves sAmauraMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 6358}, // commented out because AI handles the move badly
	{MOVE_BLIZZARD, 3352},
...
static const struct SmogonTeammates sAmauraTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 3450},
	{SPECIES_ANORITH, 3204},
	{SPECIES_SANDSHREW_ALOLAN, 2767},
	{SPECIES_PONYTA_GALARIAN, 2124},
	{SPECIES_BONSLY, 1941},
...
static const struct SmogonMoves sStunkyMoves_gen8lc[] =
{
	...
	// {MOVE_TAUNT, 693}, // commented out because AI handles the move badly
	{MOVE_ACID_SPRAY, 166},
};
...
static const struct SmogonMoves sSandygastMoves_gen8lc[] =
{
	...
	// {MOVE_SUBSTITUTE, 369}, // commented out because AI handles the move badly
	{MOVE_TRICK, 52},
};
...
{
	{MOVE_CURSE, 6428},
	// {MOVE_SUBSTITUTE, 6317}, // commented out because AI handles the move badly
	// {MOVE_PROTECT, 6244}, // commented out because AI handles the move badly
	{MOVE_PSYCHIC, 5132},
...
static const struct SmogonTeammates sPhantumpTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 3285},
...
{
	{MOVE_WISH, 9999},
	// {MOVE_PROTECT, 9999}, // commented out because AI handles the move badly
	{MOVE_BODY_SLAM, 9806},
	{MOVE_KNOCK_OFF, 9709},
	{MOVE_THIEF, 224},
	{MOVE_HEAL_BELL, 188},
...
static const struct SmogonTeammates sLickitungTeammates_gen8lc[] =
{
	...
	{SPECIES_MEOWTH_ALOLAN, 224},
	{SPECIES_AMAURA, 188},
	{SPECIES_ARCHEN, 188},
	{SPECIES_SANDSHREW_ALOLAN, 188},
	{SPECIES_SNOVER, 188},
	{SPECIES_RHYHORN, 176},
...
static const struct SmogonMoves sTirtougaMoves_gen8lc[] =
{
	...
	{MOVE_ICE_BEAM, 5590},
	// {MOVE_PROTECT, 5585}, // commented out because AI handles the move badly
	{MOVE_SURF, 5585},
...
static const struct SmogonTeammates sDarumakaTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 2049},
	{SPECIES_FERROSEED, 174},
	{SPECIES_MIENFOO, 150},
	{SPECIES_FOONGUS, 149},
	{SPECIES_DIGLETT, 149},
...
static const struct SmogonMoves sWingullMoves_gen8lc[] =
{
	...
	{MOVE_SCALD, 9927},
	{MOVE_KNOCK_OFF, 6524},
	// {MOVE_SUBSTITUTE, 5488}, // commented out because AI handles the move badly
	// {MOVE_PROTECT, 2883}, // commented out because AI handles the move badly
...
static const struct SmogonTeammates sWingullTeammates_gen8lc[] =
{
	...
	{SPECIES_PONYTA_GALARIAN, 1087},
	{SPECIES_SPRITZEE, 1087},
	{SPECIES_MAGNEMITE, 658},
	{SPECIES_PSYDUCK, 658},
	{SPECIES_KOFFING, 572},
	{SPECIES_GOLETT, 520},
	{SPECIES_SANDSHREW_ALOLAN, 520},
	{SPECIES_GROOKEY, 497},
	{SPECIES_STUNKY, 94},
	{SPECIES_AMAURA, 67},
	{SPECIES_SALANDIT, 52},
...
static const struct SmogonMoves sGrowlitheMoves_gen8lc[] =
{
	...
	{MOVE_PLAY_ROUGH, 188},
	{MOVE_OVERHEAT, 150},
	// {MOVE_PROTECT, 74}, // commented out because AI handles the move badly
	{MOVE_TOXIC, 74},
};
...
static const struct SmogonTeammates sGrowlitheTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 1350},
...
static const struct SmogonMoves sVenipedeMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 5610}, // commented out because AI handles the move badly
...
static const struct SmogonTeammates sVenipedeTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 3194},
	{SPECIES_MAGBY, 3194},
	{SPECIES_NATU, 1475},
...
{
	// {MOVE_PROTECT, 9443}, // commented out because AI handles the move badly
	...
	{MOVE_ROAR, 105},
	// {MOVE_SUBSTITUTE, 59}, // commented out because AI handles the move badly
};
...
static const struct SmogonTeammates sHonedgeTeammates_gen8lc[] =
{
	...
	{SPECIES_PAWNIARD, 1226},
	{SPECIES_FARFETCHD_GALARIAN, 1154},
...
static const struct SmogonMoves sCottoneeMoves_gen8lc[] =
{
	...
	// {MOVE_TAUNT, 1400}, // commented out because AI handles the move badly
	{MOVE_COTTON_GUARD, 659},
	{MOVE_NATURE_POWER, 396},
	// {MOVE_SUBSTITUTE, 267}, // commented out because AI handles the move badly
	{MOVE_TOXIC, 121},
	{MOVE_SWITCHEROO, 54},
};
...
static const struct SmogonMoves sSnoverMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 9047}, // commented out because AI handles the move badly
...
static const struct SmogonTeammates sBaltoyTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 7487},
...
static const struct SmogonMoves sOmanyteMoves_gen8lc[] =
{
	...
	{MOVE_SURF, 4950},
	// {MOVE_SUBSTITUTE, 4769}, // commented out because AI handles the move badly
...
static const struct SmogonMoves sAronMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 2005}, // commented out because AI handles the move badly
...
static const struct SmogonTeammates sAronTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 1433},
...
static const struct SmogonMoves sSalanditMoves_gen8lc[] =
{
	...
	// {MOVE_SUBSTITUTE, 868}, // commented out because AI handles the move badly
	{MOVE_DRAGON_PULSE, 673},
	{MOVE_SWIFT, 663},
	{MOVE_NASTY_PLOT, 519},
	// {MOVE_PROTECT, 120}, // commented out because AI handles the move badly
	{MOVE_MUD_SLAP, 120},
...
static const struct SmogonTeammates sSalanditTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 138},
	{SPECIES_TYRUNT, 138},
	{SPECIES_WAILMER, 138},
	{SPECIES_KOFFING, 120},
	{SPECIES_SOLOSIS, 120},
...
static const struct SmogonMoves sTorchicMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 2334}, // commented out because AI handles the move badly
...
static const struct SmogonMoves sLittenMoves_gen8lc[] =
{
	...
	// {MOVE_TAUNT, 3389}, // commented out because AI handles the move badly
	{MOVE_OVERHEAT, 3354},
	{MOVE_U_TURN, 565},
	{MOVE_CRUNCH, 292},
	{MOVE_LEECH_LIFE, 98},
...
static const struct SmogonTeammates sBronzorTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 745},
	{SPECIES_MIME_JR, 745},
...
static const struct SmogonMoves sBonslyMoves_gen8lc[] =
{
	...
	{MOVE_EXPLOSION, 9257},
	{MOVE_COUNTER, 9227},
	// {MOVE_PROTECT, 9227}, // commented out because AI handles the move badly
...
static const struct SmogonTeammates sBonslyTeammates_gen8lc[] =
{
	{SPECIES_ABRA, 9971},
	{SPECIES_AMAURA, 9227},
	{SPECIES_FARFETCHD_GALARIAN, 9227},
	{SPECIES_PONYTA_GALARIAN, 9227},
	{SPECIES_SANDSHREW_ALOLAN, 9227},
	{SPECIES_ANORITH, 753},
...
static const struct SmogonTeammates sMime_JrTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 609},
...
static const struct SmogonMoves sFletchlingMoves_gen8lc[] =
{
	...
	{MOVE_HEAT_WAVE, 894},
	{MOVE_DEFOG, 755},
	// {MOVE_PROTECT, 237}, // commented out because AI handles the move badly
	{MOVE_STEEL_WING, 161},
};
...
static const struct SmogonMoves sPurrloinMoves_gen8lc[] =
{
	...
	{MOVE_PLAY_ROUGH, 356},
	{MOVE_TRICK, 120},
	// {MOVE_TAUNT, 103}, // commented out because AI handles the move badly
};
...
static const struct SmogonMoves sWimpodMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 9998}, // commented out because AI handles the move badly
};
...
static const struct SmogonTeammates sYamask_GalarTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 7697},
	{SPECIES_PONYTA, 7697},
...
static const struct SmogonMoves sRemoraidMoves_gen8lc[] =
{
	...
	{MOVE_ICE_BEAM, 9189},
	{MOVE_PSYCHIC, 9189},
	// {MOVE_PROTECT, 811}, // commented out because AI handles the move badly
	{MOVE_HYDRO_PUMP, 426},
	{MOVE_HYPER_BEAM, 426},
...
static const struct SmogonMoves sHelioptileMoves_gen8lc[] =
{
	...
	// {MOVE_SUBSTITUTE, 497}, // commented out because AI handles the move badly
	{MOVE_THUNDER, 321},
	{MOVE_U_TURN, 76},
...
static const struct SmogonTeammates sMinccinoTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 8123},
...
static const struct SmogonMoves sAxewMoves_gen8lc[] =
{
	...
	// {MOVE_TAUNT, 724}, // commented out because AI handles the move badly
	{MOVE_X_SCISSOR, 352},
	{MOVE_AQUA_TAIL, 58},
	{MOVE_ROAR, 58},
};
...
static const struct SmogonMoves sKabutoMoves_gen8lc[] =
{
	...
	{MOVE_AQUA_JET, 2456},
	// {MOVE_PROTECT, 2221}, // commented out because AI handles the move badly
	{MOVE_WATERFALL, 132},
...
static const struct SmogonMoves sWailmerMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 2245}, // commented out because AI handles the move badly
	{MOVE_TICKLE, 2245},
	{MOVE_BLIZZARD, 642},
	{MOVE_CLEAR_SMOG, 216},
};
...
static const struct SmogonMoves sImpidimpMoves_gen8lc[] =
{
	...
	{MOVE_TRICK, 9892},
	// {MOVE_TAUNT, 9543}, // commented out because AI handles the move badly
	{MOVE_FAKE_OUT, 349},
	{MOVE_DARK_PULSE, 108},
	{MOVE_DRAINING_KISS, 105},
	// {MOVE_PROTECT, 105}, // commented out because AI handles the move badly
};
...
static const struct SmogonMoves sGossifleurMoves_gen8lc[] =
{
	...
	{MOVE_SYNTHESIS, 9912},
	{MOVE_LEECH_SEED, 88},
	// {MOVE_PROTECT, 88}, // commented out because AI handles the move badly
};
...
static const struct SmogonMoves sEeveeMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 893}, // commented out because AI handles the move badly
...
static const struct SmogonMoves sBergmiteMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 8708}, // commented out because AI handles the move badly
...
static const struct SmogonMoves sPichuMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 97}, // commented out because AI handles the move badly
	{MOVE_WISH, 82},
	{MOVE_FAKE_OUT, 52},
};
...
static const struct SmogonMoves sCuboneMoves_gen8lc[] =
{
	...
	{MOVE_TOXIC, 2237},
	// {MOVE_SUBSTITUTE, 563}, // commented out because AI handles the move badly
	{MOVE_IRON_HEAD, 563},
	{MOVE_ROCK_SLIDE, 563},
	{MOVE_FACADE, 163},
};
...
static const struct SmogonTeammates sKlinkTeammates_gen8lc[] =
{
	...
	{SPECIES_FARFETCHD_GALARIAN, 881},
...
static const struct SmogonTeammates sStuffulTeammates_gen8lc[] =
{
	...
	{SPECIES_SWABLU, 392},
	{SPECIES_ZIGZAGOON_GALARIAN, 392},
	{SPECIES_ABRA, 290},
	{SPECIES_ARCHEN, 290},
	{SPECIES_DRILBUR, 290},
...
static const struct SmogonMoves sShelmetMoves_gen8lc[] =
{
	...
	{MOVE_TOXIC, 2582},
	// {MOVE_PROTECT, 1753}, // commented out because AI handles the move badly
	{MOVE_YAWN, 393},
};
...
static const struct SmogonMoves sBinacleMoves_gen8lc[] =
{
	...
	// {MOVE_PROTECT, 9871}, // commented out because AI handles the move badly
